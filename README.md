...
|---|---|---|
| Escrow | `TODO — paste C… address here after deploy` | ☐ |
| Smart Wallet | `TODO — paste C… address here (or mark N/A if on fallback)` | ☐ |
...
| [`docs/`](docs/) | Product pitch, architecture, and **PM coordination** | PM |
...
3. **Everyone:** check the daily plan in [`docs/pm/TIMELINE.md`](docs/pm/TIMELINE.md) and your tasks
   in [`docs/pm/TASK-BOARD.md`](docs/pm/TASK-BOARD.md).
...
real money. See [`docs/pm/SUBMISSION-CHECKLIST.md`](docs/pm/SUBMISSION-CHECKLIST.md) for the deliverable gate.
